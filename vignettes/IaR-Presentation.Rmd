...
plot_df %>% 
  ...
  geom_line(aes(date, total_value), size = 1, color = "blue") + 
...
## Accounting for Effective Lower Bound - Inflation environment is still important
...
## BoI rate{.unlisted .unnumbered}


```{r eval=FALSE}

monetary_df = MiscImport::import_boi_monetary_df()

monetary_df %>% 
  ggplot(aes(date, boi_interest_nominal)) + 
  geom_line() + 
