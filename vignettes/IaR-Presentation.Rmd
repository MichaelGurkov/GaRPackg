...
## Oil prices stimulate inflation and increase uncertainty and skeweness one year ahead
...
df %>% 
  ...
  annotate("rect", xmin = as.yearmon("Sep 2014"),
           xmax = as.yearmon("Jan 2019"),
           ymin=0, ymax=Inf,
           alpha = 0.5, fill="lightblue") + 
  geom_text(aes(x = as.yearmon("Sep 2016"), y = 4.5),
            label = "Effective Lower \n Bound period") + 
...
## Factor decomposition{.unlisted .unnumbered}
