...
In order to demonstrate data transformation we transform the features to "year on year" changes. This can also be done as a step in the workflow using %>% operator rather than as a separate step.
