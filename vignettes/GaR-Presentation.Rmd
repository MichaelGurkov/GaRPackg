...
gar_analysis %>%
  ...
  labs(caption = paste0("Notes: Each column shows the estimated coefficients ",
                        ...
                        "(see Koenker, 1994)"), title = "Sample: 1996Q3-2019Q4") + 
...
Financial factors coefficients at different quantiles
...
\setlength\itemsep{2em}
	...
	\end{enumerate}
	\item
	All models are evaluated out of sample (expanding window starts at
