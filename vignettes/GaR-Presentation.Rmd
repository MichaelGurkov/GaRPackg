...
df = raw_df %>%
  select(date,gdp, any_of(unlist(partitions_list,use.names = FALSE))) %>% 
...
\begin{itemize}
	\item
	Macro-financial model  developed by Adrian et al. (2019).
	
	
	\begin{itemize}
		\item Operationalized by IMF (Prasad et al., 2019).
		\item
		Applied for: 
		\begin{itemize}
...
```{r plot_skew_robustness, cache=TRUE, dev="png", eval=FALSE}
