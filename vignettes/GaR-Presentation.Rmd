...
events_plot = tribble(
  ...
  mutate(event = factor(event, levels = c("Second Intifada","Great Financial Crises")))
...
```{r skewness_figure, out.height="85%"}
...
## Risk dist. symmetry  consistent with features of past GDP growth
