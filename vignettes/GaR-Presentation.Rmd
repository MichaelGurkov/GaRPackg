...
# Methodology and Data  \label{methodology}
## Methodology
[@Prasad2019]
\begin{enumerate}
	\item
	...
	\vspace{1em   }
	\begin{flushright}
		\hyperlink{quantile_reg}{\beamergotobutton{Quantile reg}}
	\end{flushright}
\end{enumerate}
...
# Estimation Results
## $1^{st}$ Principal Components \label{pca_timeseries}
...
## Quantile regression coefficients  \label{selectedcoefs}
...
\hyperlink{methodology}{\beamerreturnbutton{Methodology}}
\end{flushleft}
...
\hyperlink{selectedcoefs}{\beamergotobutton{selectedcoefs}}
