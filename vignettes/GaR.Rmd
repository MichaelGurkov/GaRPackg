...
# michael_partitions = partitions
# 
# michael_partitions$Rates = michael_partitions[c("Spread","Rates")] %>% 
#   setNames(NULL) %>% 
#   unlist() %>% 
#   as.list()
# 
# michael_partitions = michael_partitions[!names(michael_partitions) == "Spread"]
...
results$long_series = run.GaR.analysis(partitions_list = baseline_partitions,
                               vars_df = data_list$long_series_df,
                               horizon_list = parameters_list$horizon_list,
                               quantile_vec = parameters_list$quantile_vec)

# results$interpolated = run.GaR.analysis(partitions_list = baseline_partitions,
