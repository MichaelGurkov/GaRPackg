...
partitions = list(Dom_Real = list("GDP_F","Ind_Prod_Israel",
                                  ...
                                  "STARTUP_FP","Wage","EMP","Unemp_rate","Vacancies_Rate"),
                  ...
                  Global = list("VIX","Ind_Prod_advanced",
                                ...
                                "IMP_OECD"),
                  Risk = list("Spread_CPI_corp", "ILS_USD_spread_pct","Interbank_spread",
                              "Sovereigh_spread","ILS_USD_impl_vol","TA_35_impl_vol",
                              "Term_spread","Tourists","BOI_rate","Telbor_1Y",
                              "real_rate_1","real_rate_2_3_fwd","real_rate_5_10_fwd"),
...
results = run.GaR.analysis(partitions_list = partitions,
                   vars_df = df,
