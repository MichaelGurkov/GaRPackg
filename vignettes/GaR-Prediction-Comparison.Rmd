...
specification. The out of sample forecast is constructed by estimation of a rolling window of length
...
GDP YoY growth rates. That basically means looking at the residual
(difference between actual and predicted) values of the quantile regression.
...
\section{Comparison to constant}

```{r}

constant_gar = run.GaR.analysis(partitions_list = partitions_list$macro,
                                vars_df = df,
