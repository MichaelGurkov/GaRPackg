...
@Adrian2019 is a seminal paper that lays the foundation of the GaR approach. The authors model the
full distribution of GDP growth as a function of current economic and financial conditions. The empirical specification is quite limited : economic conditions are represented by GDP growth and
financial conditions are represented by National Financial Conditions Index (NFCI). The NFCI 
provides a weekly estimate of US financial conditions in money markets, debt and equity markets, and the traditional and shadow banking systems. The empirical analysis involves estimating conditional quantiles (using quantile regression) and fitting a skewed t distribution. The authors
introduce several risk measures:

\begin{itemize}
  \item
  Upside (downside) enthropy measures the downside (upside) risks in excess of the risks predicted
  by economic condition. The upside enthropy is calculated as the cumulative difference between
  conditional (on financial conditions) and unconditional GDP growth distribution.
  \item
  Expected shortfall (expected longrise) measures the total probability mass that the conditional
  distribution assign to the left (right) tail of the distribution.

The sample period spans 1973Q1-2018Q4 and the two forecast horizons are a quarter and a year ahead.
The authors find a negative correlation between the median and the interquartile range of the future growth distribution. A comparison of conditioning on past GDP growth only vs conditioning on both GDP and financial conditions reveals that during business cycle
expansion financial conditions result lower variance and positive skewness relative to conditioning 
on GDP only. However, during business cycle contractions financial conditions induce greater
variance, negative skewness and lower mean. 
