...
We can also try to asses the contribution of each factor to the volatility paradox. The volatility paradox suggest that the 
...
ggplot(factor_quantiles_df, aes(x = Horizon, y = IQR, group = 1)) + 
  geom_path() + 
  geom_point() + 
  labs(y = "", title = "The difference between \"tail\" coefficients") + 
  facet_wrap(~Factor) + 
  theme_bw() + 
...
of the 5th percentile form the median should be larger relative to the distance of the 95th 
