...
models_list = list(intercept = NULL,
                   real_only = partitions_list[c("dom_macro","ext_macro")],
                   gar = partitions_list)


gar_forecast = map_dfr(models_list, function(temp__part){
  
  temp_forecast = get_gar_forecast(
    partitions_list = temp__part,
    vars_df = df,
    target_var_name = "gdp",
