...
#'
quantile.fit.score.area = function(realized_estimate, quantile_values, quantiles){
  ...
  # Calculate realized estimate prob
  ...
  if(real_est_ind == 1){
    ...
    weight = (vec[real_est_ind] - 1) /
      (vec[real_est_ind - 1] - 1)
